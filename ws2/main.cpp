...
/// <summary>
/// Reads a sensor data file and loads readings into a dynamically allocated
/// Samples structure. The first line of the file is treated as the title
/// (prefixed by #). The readings are added in chunks of 50 using the add()
/// function.
/// </summary>
/// <param name="filename">The path to the data file.</param>
/// <returns>A dynamically allocated Samples pointer, or nullptr if the file
/// can't be opened.</returns>
...
int main() {
    ...
    if (sample) {
        ...
        cout << "Readings in Optimal Range (90-110C): " << inRange << " ("
             << percent << "%)\n";

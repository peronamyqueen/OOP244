/*
I have copied the code that my professor provided to complete my work for
function whatever.
*/
...
/// </summary>
/// <param name="readings">Pointer to an array of integer sensor
/// readings.</param> <param name="size">Number of elements in the readings
/// array.</param> <returns>The average value as a double. Returns 0.0 if size
/// is 0.</returns>
...
/// <param name="readings">Pointer to the array of sensor readings.</param>
/// <param name="size">Number of elements in the array.</param>
/// <returns>Maximum drop found between adjacent readings. Returns 0 if size
/// &lt; 2.</returns>
